...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		com.foodoon.news.entity.main.CmsModel model,
	...
	// one to one
	private com.foodoon.news.entity.main.ChannelExt channelExt;

	// many to one
	private com.foodoon.news.entity.main.CmsSite site;
	private com.foodoon.news.entity.main.CmsModel model;
	private com.foodoon.news.entity.main.Channel parent;

	// collections
	private java.util.Set<com.foodoon.news.entity.main.Channel> child;
	private java.util.Set<com.foodoon.news.entity.main.CmsGroup> viewGroups;
	private java.util.Set<com.foodoon.news.entity.main.CmsGroup> contriGroups;
	private java.util.Set<com.foodoon.news.entity.main.CmsUser> users;
	private java.util.Set<com.foodoon.news.entity.main.ChannelTxt> channelTxtSet;
	private java.util.List<com.foodoon.news.entity.main.ChannelModel> channelModels;
	 ...
	 */
	public com.foodoon.news.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (com.foodoon.news.entity.main.ChannelExt channelExt) {
	 ...
	 */
	public com.foodoon.news.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.foodoon.news.entity.main.Channel parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.foodoon.news.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.main.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<com.foodoon.news.entity.main.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.main.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.foodoon.news.entity.main.CmsUser> users) {
		this.users = users;
	}
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<com.foodoon.news.entity.main.ChannelTxt> channelTxtSet) {
		this.channelTxtSet = channelTxtSet;
	}

	public java.util.List<com.foodoon.news.entity.main.ChannelModel> getChannelModels() {
		return channelModels;
	}

	public void setChannelModels(
			java.util.List<com.foodoon.news.entity.main.ChannelModel> channelModels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.main.Channel)) return false;
		else {
			com.foodoon.news.entity.main.Channel channel = (com.foodoon.news.entity.main.Channel) obj;
