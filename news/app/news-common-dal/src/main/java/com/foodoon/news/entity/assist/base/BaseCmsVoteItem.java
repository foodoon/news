...
public abstract class BaseCmsVoteItem  implements Serializable {
	...
	public BaseCmsVoteItem (
		...
		com.foodoon.news.entity.assist.CmsVoteTopic topic,
	...
	// many to one
	private com.foodoon.news.entity.assist.CmsVoteTopic topic;
	private com.foodoon.news.entity.assist.CmsVoteSubTopic subTopic;
	 ...
	 */
	public com.foodoon.news.entity.assist.CmsVoteTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.foodoon.news.entity.assist.CmsVoteTopic topic) {
		this.topic = topic;
	}
	

	public com.foodoon.news.entity.assist.CmsVoteSubTopic getSubTopic() {
		return subTopic;
	}

	public void setSubTopic(com.foodoon.news.entity.assist.CmsVoteSubTopic subTopic) {
		this.subTopic = subTopic;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsVoteItem)) return false;
		else {
			com.foodoon.news.entity.assist.CmsVoteItem cmsVoteItem = (com.foodoon.news.entity.assist.CmsVoteItem) obj;
