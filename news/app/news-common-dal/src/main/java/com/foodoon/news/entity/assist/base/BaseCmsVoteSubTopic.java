...
public abstract class BaseCmsVoteSubTopic  implements Serializable {
	...
	public BaseCmsVoteSubTopic (
		...
		com.foodoon.news.entity.assist.CmsVoteTopic voteTopic,
	...
	// many to one
	private com.foodoon.news.entity.assist.CmsVoteTopic voteTopic;

	// collections
	private java.util.Set<com.foodoon.news.entity.assist.CmsVoteItem> voteItems;
	private java.util.Set<com.foodoon.news.entity.assist.CmsVoteReply> voteReplys;
	 ...
	 */
	public com.foodoon.news.entity.assist.CmsVoteTopic getVoteTopic () {
		return voteTopic;
	}
	 ...
	 */
	public void setVoteTopic (com.foodoon.news.entity.assist.CmsVoteTopic voteTopic) {
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.assist.CmsVoteItem> getVoteItems () {
		return voteItems;
	}
	 ...
	 */
	public void setVoteItems (java.util.Set<com.foodoon.news.entity.assist.CmsVoteItem> voteItems) {
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.assist.CmsVoteReply> getVoteReplys () {
		return voteReplys;
	}
	 ...
	 */
	public void setVoteReplys (java.util.Set<com.foodoon.news.entity.assist.CmsVoteReply> voteReplys) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsVoteSubTopic)) return false;
		else {
			com.foodoon.news.entity.assist.CmsVoteSubTopic cmsVoteSubTopic = (com.foodoon.news.entity.assist.CmsVoteSubTopic) obj;
