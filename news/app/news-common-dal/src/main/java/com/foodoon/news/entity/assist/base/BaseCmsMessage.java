...
public abstract class BaseCmsMessage  implements Serializable {
	...
	// many to one
	private com.foodoon.news.entity.main.CmsUser msgReceiverUser;
	private com.foodoon.news.entity.main.CmsUser msgSendUser;
	private com.foodoon.news.entity.main.CmsSite site;
	
	// collections
	private java.util.Set<com.foodoon.news.entity.assist.CmsReceiverMessage> receiverMsgs;
	 ...
	 */
	public com.foodoon.news.entity.main.CmsUser getMsgReceiverUser () {
	 ...
	 */
	public void setMsgReceiverUser (com.foodoon.news.entity.main.CmsUser msgReceiverUser) {
	 ...
	 */
	public com.foodoon.news.entity.main.CmsUser getMsgSendUser () {
		return msgSendUser;
	}
	 ...
	 */
	public void setMsgSendUser (com.foodoon.news.entity.main.CmsUser msgSendUser) {
	...
	public java.util.Set<com.foodoon.news.entity.assist.CmsReceiverMessage> getReceiverMsgs() {
		return receiverMsgs;
	}

	public void setReceiverMsgs(
			java.util.Set<com.foodoon.news.entity.assist.CmsReceiverMessage> receiverMsgs) {
		this.receiverMsgs = receiverMsgs;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsMessage)) return false;
		else {
			com.foodoon.news.entity.assist.CmsMessage cmsMessage = (com.foodoon.news.entity.assist.CmsMessage) obj;
