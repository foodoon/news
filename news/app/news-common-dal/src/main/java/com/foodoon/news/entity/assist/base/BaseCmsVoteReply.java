...
public abstract class BaseCmsVoteReply  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsVoteReply)) return false;
		else {
			com.foodoon.news.entity.assist.CmsVoteReply cmsVoteReply = (com.foodoon.news.entity.assist.CmsVoteReply) obj;
