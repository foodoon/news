package com.foodoon.news.entity.assist.base;
...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.foodoon.news.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private com.foodoon.news.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.foodoon.news.entity.main.CmsUser member;
	private com.foodoon.news.entity.main.CmsUser admin;
	private com.foodoon.news.entity.main.CmsSite site;
	private com.foodoon.news.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.foodoon.news.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.foodoon.news.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.foodoon.news.entity.main.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.foodoon.news.entity.main.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.foodoon.news.entity.main.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.foodoon.news.entity.main.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.foodoon.news.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.foodoon.news.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsGuestbook)) return false;
		else {
			com.foodoon.news.entity.assist.CmsGuestbook cmsGuestbook = (com.foodoon.news.entity.assist.CmsGuestbook) obj;
