...
public abstract class BaseCmsVoteRecord  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsVoteRecord)) return false;
		else {
			com.foodoon.news.entity.assist.CmsVoteRecord cmsVoteRecord = (com.foodoon.news.entity.assist.CmsVoteRecord) obj;
