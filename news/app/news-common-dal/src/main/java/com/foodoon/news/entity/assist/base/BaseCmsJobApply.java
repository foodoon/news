...
public abstract class BaseCmsJobApply  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsJobApply)) return false;
		else {
			com.foodoon.news.entity.assist.CmsJobApply cmsJobApply = (com.foodoon.news.entity.assist.CmsJobApply) obj;
