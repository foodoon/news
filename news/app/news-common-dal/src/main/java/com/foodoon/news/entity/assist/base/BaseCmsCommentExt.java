...
public abstract class BaseCmsCommentExt  implements Serializable {
	...
	// one to one
	private com.foodoon.news.entity.assist.CmsComment comment;
	 ...
	 */
	public com.foodoon.news.entity.assist.CmsComment getComment () {
		return comment;
	}
	 ...
	 */
	public void setComment (com.foodoon.news.entity.assist.CmsComment comment) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsCommentExt)) return false;
		else {
			com.foodoon.news.entity.assist.CmsCommentExt cmsCommentExt = (com.foodoon.news.entity.assist.CmsCommentExt) obj;
