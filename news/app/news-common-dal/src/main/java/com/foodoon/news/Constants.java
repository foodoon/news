...
public class Constants {
	 ...
	 * 资源路径
	 */
	public static final String RES_PATH = "/static/global";
	/**
	 * 模板路径
	 */
	public static final String TPL_BASE = "/WEB-INF/guest";
	/**
	 * 全文检索索引路径
	 */
	 ...
	 * 列表样式模板路径
	 */
	public static final String TPL_STYLE_LIST = "/WEB-INF/guest_custom/style_list/style_";
	/**
	 * 内容分页模板路径
	 */
	public static final String TPL_STYLE_PAGE_CONTENT = "/WEB-INF/guest_custom/style_page/content_";
	/**
	 * 列表分页模板路径
	 */
	public static final String TPL_STYLE_PAGE_CHANNEL = "/WEB-INF/guest_custom/style_page/channel_";
	/**
	 * 页面禁止访问
	 */
	 ...
	 * 数据库备份文本前缀
	 */
	public static String ONESQL_PREFIX="FOODOON_BACKUP_";
	/**
	 * 防火墙配置文件
	 */
