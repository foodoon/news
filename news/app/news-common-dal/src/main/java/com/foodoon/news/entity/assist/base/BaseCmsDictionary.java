...
public abstract class BaseCmsDictionary  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsDictionary)) return false;
		else {
			com.foodoon.news.entity.assist.CmsDictionary cmsDictionary = (com.foodoon.news.entity.assist.CmsDictionary) obj;
