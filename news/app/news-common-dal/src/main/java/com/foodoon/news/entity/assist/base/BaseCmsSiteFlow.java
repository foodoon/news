...
public abstract class BaseCmsSiteFlow  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsSiteFlow)) return false;
		else {
			com.foodoon.news.entity.assist.CmsSiteFlow cmsSiteFlow = (com.foodoon.news.entity.assist.CmsSiteFlow) obj;
