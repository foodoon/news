...
public abstract class BaseCmsModel  implements Serializable {
	...
	// collections
	private java.util.Set<com.foodoon.news.entity.main.CmsModelItem> items;
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.main.CmsModelItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.foodoon.news.entity.main.CmsModelItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.main.CmsModel)) return false;
		else {
			com.foodoon.news.entity.main.CmsModel cmsModel = (com.foodoon.news.entity.main.CmsModel) obj;
