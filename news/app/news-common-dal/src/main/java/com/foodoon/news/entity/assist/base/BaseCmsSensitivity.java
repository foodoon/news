...
public abstract class BaseCmsSensitivity  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.assist.CmsSensitivity)) return false;
		else {
			com.foodoon.news.entity.assist.CmsSensitivity cmsSensitivity = (com.foodoon.news.entity.assist.CmsSensitivity) obj;
