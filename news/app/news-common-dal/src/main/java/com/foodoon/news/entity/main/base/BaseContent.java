package com.foodoon.news.entity.main.base;
...
public abstract class BaseContent  implements Serializable {
	...
	// one to one
	private com.foodoon.news.entity.main.ContentExt contentExt;
	private com.foodoon.news.entity.main.ContentCount contentCount;

	// many to one
	private com.foodoon.news.entity.main.ContentType type;
	private com.foodoon.news.entity.main.CmsSite site;
	private com.foodoon.news.entity.main.CmsUser user;
	private com.foodoon.news.entity.main.Channel channel;
	private com.foodoon.news.entity.main.CmsModel model;

	// collections
	private java.util.Set<com.foodoon.news.entity.main.Channel> channels;
	private java.util.Set<com.foodoon.news.entity.main.CmsTopic> topics;
	private java.util.Set<com.foodoon.news.entity.main.CmsGroup> viewGroups;
	private java.util.List<com.foodoon.news.entity.main.ContentTag> tags;
	private java.util.List<com.foodoon.news.entity.main.ContentPicture> pictures;
	private java.util.List<com.foodoon.news.entity.main.ContentAttachment> attachments;
	private java.util.Set<com.foodoon.news.entity.main.ContentTxt> contentTxtSet;
	private java.util.Set<com.foodoon.news.entity.main.ContentCheck> contentCheckSet;
	private java.util.Map<java.lang.String, java.lang.String> attr;
	private java.util.Set<com.foodoon.news.entity.main.CmsUser> collectUsers;
	private java.util.Set<com.foodoon.news.entity.assist.CmsComment> comments;
	private java.util.Set<com.foodoon.news.entity.assist.CmsFile> files;
	private java.util.Set<com.foodoon.news.entity.assist.CmsJobApply> jobApplys;
	...
	public java.util.Set<com.foodoon.news.entity.assist.CmsFile> getFiles() {
		return files;
	}

	public void setFiles(java.util.Set<com.foodoon.news.entity.assist.CmsFile> files) {
		this.files = files;
	}

	public java.util.Set<com.foodoon.news.entity.assist.CmsJobApply> getJobApplys() {
		return jobApplys;
	}

	public void setJobApplys(
			java.util.Set<com.foodoon.news.entity.assist.CmsJobApply> jobApplys) {
	 ...
	 */
	public com.foodoon.news.entity.main.ContentExt getContentExt () {
		return contentExt;
	}
	 ...
	 */
	public void setContentExt (com.foodoon.news.entity.main.ContentExt contentExt) {
	 ...
	 */
	public com.foodoon.news.entity.main.ContentCount getContentCount () {
		return contentCount;
	}
	 ...
	 */
	public void setContentCount (com.foodoon.news.entity.main.ContentCount contentCount) {
	 ...
	 */
	public com.foodoon.news.entity.main.ContentType getType () {
		return type;
	}
	 ...
	 */
	public void setType (com.foodoon.news.entity.main.ContentType type) {
		this.type = type;
	}
	 ...
	 */
	public com.foodoon.news.entity.main.CmsSite getSite () {
		return site;
	}
	 ...
	 */
	public void setSite (com.foodoon.news.entity.main.CmsSite site) {
		this.site = site;
	}
	 ...
	 */
	public com.foodoon.news.entity.main.CmsUser getUser () {
		return user;
	}
	 ...
	 */
	public void setUser (com.foodoon.news.entity.main.CmsUser user) {
		this.user = user;
	}
	 ...
	 */
	public com.foodoon.news.entity.main.Channel getChannel () {
		return channel;
	}
	 ...
	 */
	public void setChannel (com.foodoon.news.entity.main.Channel channel) {
		this.channel = channel;
	}
	
	public com.foodoon.news.entity.main.CmsModel getModel() {
		return model;
	}

	public void setModel(com.foodoon.news.entity.main.CmsModel model) {
		this.model = model;
	}
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.main.Channel> getChannels () {
		return channels;
	}
	 ...
	 */
	public void setChannels (java.util.Set<com.foodoon.news.entity.main.Channel> channels) {
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.main.CmsTopic> getTopics () {
		return topics;
	}
	 ...
	 */
	public void setTopics (java.util.Set<com.foodoon.news.entity.main.CmsTopic> topics) {
		this.topics = topics;
	}
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.main.CmsGroup> getViewGroups () {
		return viewGroups;
	}
	 ...
	 */
	public void setViewGroups (java.util.Set<com.foodoon.news.entity.main.CmsGroup> viewGroups) {
	 ...
	 */
	public java.util.List<com.foodoon.news.entity.main.ContentTag> getTags () {
		return tags;
	}
	 ...
	 */
	public void setTags (java.util.List<com.foodoon.news.entity.main.ContentTag> tags) {
		this.tags = tags;
	}
	 ...
	 */
	public java.util.List<com.foodoon.news.entity.main.ContentPicture> getPictures () {
		return pictures;
	}
	 ...
	 */
	public void setPictures (java.util.List<com.foodoon.news.entity.main.ContentPicture> pictures) {
	 ...
	 */
	public java.util.List<com.foodoon.news.entity.main.ContentAttachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.List<com.foodoon.news.entity.main.ContentAttachment> attachments) {
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.main.ContentTxt> getContentTxtSet () {
	 ...
	 */
	public void setContentTxtSet (java.util.Set<com.foodoon.news.entity.main.ContentTxt> contentTxtSet) {
	 ...
	 */
	public java.util.Set<com.foodoon.news.entity.main.ContentCheck> getContentCheckSet () {
	 ...
	 */
	public void setContentCheckSet (java.util.Set<com.foodoon.news.entity.main.ContentCheck> contentCheckSet) {
	...
	public java.util.Set<com.foodoon.news.entity.main.CmsUser> getCollectUsers() {
		return collectUsers;
	}

	public void setCollectUsers(
			java.util.Set<com.foodoon.news.entity.main.CmsUser> collectUsers) {
		this.collectUsers = collectUsers;
	}
	

	public java.util.Set<com.foodoon.news.entity.assist.CmsComment> getComments() {
		return comments;
	}

	public void setComments(
			java.util.Set<com.foodoon.news.entity.assist.CmsComment> comments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.news.entity.main.Content)) return false;
		else {
			com.foodoon.news.entity.main.Content content = (com.foodoon.news.entity.main.Content) obj;
