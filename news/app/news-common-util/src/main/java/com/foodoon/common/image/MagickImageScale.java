package com.foodoon.common.image;
...
import com.foodoon.common.image.ImageUtils.Position;
...
public class MagickImageScale {
	...
	public static void main(String[] args) throws Exception {
		...
		MagickImageScale.resizeFix(
				new File("test/com/foodoon/common/util/1.bmp"), new File(
						"test/com/foodoon/common/util/1-n-3.bmp"), 310, 310, 50,
				50, 320, 320);
