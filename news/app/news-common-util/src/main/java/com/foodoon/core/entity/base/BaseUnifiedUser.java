...
public abstract class BaseUnifiedUser  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.foodoon.core.entity.UnifiedUser)) return false;
		else {
			com.foodoon.core.entity.UnifiedUser unifiedUser = (com.foodoon.core.entity.UnifiedUser) obj;
