...
import com.foodoon.common.page.Paginable;
import com.foodoon.common.page.SimplePage;
...
public class DynamicPageAct {
	...
	public String index(HttpServletRequest request, ModelMap model) {
		...
		String dex = FrontUtils.getTplPath(request, site.getSolutionPath(),
				TPLDIR_INDEX, StaticPageSvcImpl.TPL_INDEX);
        return dex;
	}
